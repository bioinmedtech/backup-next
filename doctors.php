...
$socialImageUrl = bioinmed_og_image_url('doctors');
                ...
                <div class="fade-up grid items-start gap-8 md:grid-cols-[380px_1fr] lg:grid-cols-[460px_1fr]">
                    <div class="w-full max-w-[480px]" data-admin-block-root>
                        ...
                        <p class="caveat-reveal mt-4 max-w-none text-[#0a293c]" style="font-family:'Caveat',cursive;font-size:clamp(1.35rem,4vw,1.8rem);line-height:1.22;font-weight:700;">
                            <span class="caveat-reveal" style="font-family:'Caveat',cursive;"<?php echo bioinmed_page_text_attr($doctorsPage, 'doctors', 'chief_quote.text'); ?>><?php echo e($doctorsChiefQuote['text'] ?? ''); ?></span>
                        </p>
                        <p class="caveat-reveal mt-2 text-[1.08rem] font-semibold tracking-[0.04em] text-[#4a6f9c]" style="font-family:'Caveat',cursive;font-weight:700;"<?php echo bioinmed_page_text_attr($doctorsPage, 'doctors', 'chief_quote.sign'); ?>><?php echo e($doctorsChiefQuote['sign'] ?? ''); ?></p>
                    <?php endif; ?>
                    </div>
