...
$staticPages = [
    ...
    '404' => ['file' => null, 'title' => 'Страница не найдена', 'description' => 'Запрошенная страница не найдена. Перейдите на главную или позвоните нам — команда клиники поможет найти нужную услугу.', 'eyebrow' => ''],
];
