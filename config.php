...
define('CLINIC_LICENSE_TEXT', 'СанПиН');
define('CLINIC_LICENSE_DESC', 'Соблюдаем требования МЗ РФ');
...
$problems = [
    [
        ...
        'description' => 'Боль при движении, сидячая работа, грыжа диска, артроз, колено, тазобедренный сустав, ограничение движения',
        'solutions' => 'Диагностика HABILECT, Остеопатия, Мануальная терапия, Стельки, ЛФК',
        'icon' => '🔴',
    ],
    [
        'title' => 'Головные боли и мигрени',
        'description' => 'Частые приступы, давление в голове, шейная зажатость, мигрени с аурой',
        'solutions' => 'Диагностика, Рефлексотерапия, Остеопатия, Психотерапия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Сколиоз и нарушение осанки',
        'description' => 'Искривление позвоночника, мышечные дисбалансы, профессиональная деформация, проблемы с выравниванием спины',
        'solutions' => 'HABILECT-диагностика, Остеопатия, АФК',
        'icon' => '🔴',
    ],
    [
        'title' => 'Плоскостопие, вальгус, варус и деформации стоп',
        'description' => 'Нарушение анатомии стопы, боль при ходьбе, неправильное распределение нагрузки, проблемы с равновесием',
        'solutions' => 'HABILECT-диагностика, Остеопатия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Последствия травм и операций',
        'description' => 'Восстановление после травм костей и мягких тканей, последствия операций, грубые рубцы, ограничение движения',
        'solutions' => 'HABILECT-диагностика, Физиотерапия, HILT-терапия, Мануальный терапевт, Остеопат, Ортопед, Ортопедия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Неврологические нарушения',
        'description' => 'Онемение и покалывание, нарушение чувствительности, головокружение, нарушение равновесия, невралгия',
        'solutions' => 'HABILECT-диагностика, Рефлексотерапия, Остеопатия, Физиотерапия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Синдром хронической усталости и постковид',
        'description' => 'Постоянная усталость, длительное восстановление после болезни, энергетическое истощение, нарушение работоспособности, остаточные симптомы постковида',
        'solutions' => 'Диагностика, Озоновая терапия, Инфузионная терапия, Рефлексотерапия, Психотерапия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Тревога, стресс, проблемы со сном',
        'description' => 'Тревожность, паническое расстройство, эмоциональное напряжение, бессонница, нарушение качества сна, стресс',
        'solutions' => 'Диагностика, Психотерапия, Рефлексотерапия, Микропунктура',
        'icon' => '🔴',
    ],
    [
        'title' => 'Отсутствие уверенности в себе',
        'description' => 'Сомнения в своих силах, страх оценки, неуверенность в общении и трудности с принятием решений',
        'solutions' => 'Диагностика, Психотерапия, Рефлексотерапия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Малоподвижный образ жизни: лишний вес, метаболический синдром, гипоксия',
        'description' => 'Сидячая работа, избыток веса, проблемы с дыханием, нарушение обмена веществ, низкий уровень кислорода в тканях',
        'solutions' => 'HABILECT-диагностика, Физиотерапия, Инфузионная терапия, Психотерапия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Пожилые пациенты 70+: нарушения памяти, сна, когнитивные функции, шаткость',
        'description' => 'Возрастные нарушения памяти и концентрации, проблемы со сном, нарушение равновесия, риск падений, снижение качества жизни',
        'solutions' => 'Диагностика, Консультация главного врача клиники, Рефлексотерапия, Остеопатия, Физиотерапия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Трудности с переносимостью спортивных нагрузок',
        'description' => 'Быстрая утомляемость при занятиях спортом, боль после тренировок, недостаточная выносливость, восстановление требует много времени',
        'solutions' => 'HABILECT-диагностика, Физиотерапия, Остеопатия, Рефлексотерапия',
        'icon' => '🔴',
    ],
    [
        'title' => 'Слабый иммунитет и частые ОРВИ',
        'description' => 'Частые простуды, медленное восстановление, снижение защитных сил организма, частые инфекции',
        'solutions' => 'Диагностика, Озоновая терапия, Инфузионная терапия, Рефлексотерапия',
        'icon' => '🔴',
    ],
    [
...
$doctors = [
    [
        ...
        'title' => 'Основатель, главный врач, автор лечебного проекта «Хабилект»',
        ...
        'bio' => 'Главный врач и соавтор лечебного проекта «Хабилект». Ведёт пациентов со сложными хроническими, психоэмоциональными, репродуктивными и нейросоматическими состояниями, сочетая классическую и интегративную медицину.',
        ...
        'hero_highlights' => [
            'Лично обучаю и стажирую специалистов клиники.',
            'Курирую сложные клинические случаи в рамках консилиума.',
            'Участвую в профессиональных конференциях, встречах и семинарах.',
            'Внедряю в работу клиники современные методики и инструменты.',
        ],
                ...
                'subsections' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            '2024 - Академия PRP-терапии: плазмолифтинг в косметологии и трихологии.',
                        ],
                    ],
                ],
            ],
            ...
            [
                ...
                'subsections' => [
                    ...
                    [
                        ...
                        'items' => [
                            'Сопровождение сложных случаев, в том числе онкологических.',
                    ...
                    [
                        ...
                        'items' => [
                            'Мезотерапия, биопунктура, PRP-терапия, Лаеннек- и Мэлсмон-терапия.',
                            'Карбокситерапия.',
                            'Авторская методика «Естественное омоложение организма».',
                        ],
                    ],
                    [
    ...
    [
        ...
        'title' => 'Управляющий директор клиники, соавтор лечебного проекта «Хабилект»',
    ...
    [
        ...
        'title' => 'Практический интегративный психолог',
        'specialty' => 'Интегративный психолог-консультант, полимодальный подход, психосоматическое сопровождение',
    ...
    [
        ...
        'title' => 'Специалист по диагностике и лечению острой и хронической боли',
            ...
            [
                ...
                'subsections' => [
                    ...
                    [
                        ...
                        'items' => [
                            'Аппаратная диагностика HABILECT: оценка мышечного баланса и биомеханики.',
