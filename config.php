...
$problems = [
    [
        ...
        'description' => 'Комплексная работа: консультация специалиста, функциональная диагностика (включая Хабилект и оценку стоп), персональный план лечения и поэтапная реабилитация.',
    ...
    [
        ...
        'description' => 'Выявляем причины боли, оцениваем нейромышечные и сосудистые факторы, подбираем персональный маршрут с контролем динамики.',
    ...
    [
        ...
        'description' => 'Диагностика биомеханики, коррекция мышечного дисбаланса и персональная программа ЛФК с контролем осанки и походки.',
    ...
    [
        ...
        'description' => 'Проводим диагностику стоп и всей оси движения, подбираем стельки и упражнения, корректируем перегрузки в стопах, коленях и пояснице.',
    ...
    [
        ...
        'description' => 'Строим поэтапный маршрут восстановления: диагностика, снятие боли и контрактур, возврат подвижности, контроль адаптации к нагрузке.',
    ...
    [
        ...
        'description' => 'Работаем с неврологической симптоматикой комплексно: диагностика причин, персональный план лечения и реабилитации с контролем результата.',
    ...
    [
        ...
        'description' => 'Помогаем восстановить ресурсность, переносимость нагрузок и качество сна через диагностический этап и комбинированную программу реабилитации.',
    ...
    [
        ...
        'description' => 'Сочетаем психотерапевтическое сопровождение, рефлекторные и восстановительные методики для снижения тревоги и нормализации сна.',
    ...
    [
        ...
        'description' => 'Работаем с причинами неуверенности через интегративный психотерапевтический подход и персональные программы восстановления ресурса.',
    ...
    [
        ...
        'description' => 'Формируем план восстановления активности: диагностика биомеханики, коррекция паттернов движения, поддержка обмена и адаптации к нагрузкам.',
    ...
    [
        ...
        'description' => 'Подбираем щадящую и безопасную программу для улучшения устойчивости, сна, когнитивных функций и качества жизни в пожилом возрасте.',
    ...
    [
        ...
        'description' => 'Помогаем повысить выносливость и качество восстановления: оцениваем биомеханику, корректируем перегрузки и подбираем персональный протокол.',
    ...
    [
        ...
        'description' => 'Проводим комплексную поддержку иммунитета и адаптационного ресурса с акцентом на восстановление после частых инфекций и перегрузок.',
    ...
    [
        ...
        'description' => 'Выявляем первопричины боли и перегрузок на раннем этапе: анализ опоры, биомеханики, осанки и функционального состояния в динамике.',
...
$problem_common_diagnostics = [
    ...
    '3D-диагностика опорно-двигательного аппарата на системе Хабилект.',
            ...
            [
                ...
                'subsections' => [
                    ...
                    [
                        ...
                        'items' => [
                            'Аппаратная диагностика Хабилект: оценка мышечного баланса и биомеханики.',
