...
$faq_items = [
    ...
    [
        ...
        'answer' => 'Мы работаем с наличными, картами и банковскими переводами. Доступна рассрочка на комплексные программы. Есть скидки для курсов (пакеты из 5+ сеансов). Уточняйте актуальные предложения у клиники по телефону.',
    ],
    [
        'question' => 'Можно ли записаться только по номеру телефона?',
        'answer' => 'Да. Оставьте телефон, и мы перезвоним в течение 15 минут, подберем удобное время и нужного специалиста. Или позвоните сами: +7 (495) 796-03-36.',
    ],
];
