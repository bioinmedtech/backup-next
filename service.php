    ...
    <section class="bg-white border-b border-[#e4edf6]">
        <div class="mx-auto max-w-6xl px-6 py-10 md:px-10 md:py-14">
            ...
            <div class="grid items-start gap-8 lg:grid-cols-[1fr_380px]">
                ...
                <div class="fade-up">
                    <span class="inline-flex items-center gap-2 rounded-full bg-[#e8f3fc] px-3 py-1.5 text-xs font-semibold text-[#1b5c99]">
                        <i class="fa-solid <?php echo $catIcon; ?> text-[#2fbdef]"></i> <?php echo $catLabel; ?>
                    </span>
                    ...
                    <p class="mt-4 max-w-2xl text-sm leading-relaxed text-[#355b89] md:text-[0.95rem]"><?php echo e($service['description'] ?? ''); ?></p>
                    ...
                    <div class="mt-7 flex flex-wrap gap-3">
                        ...
                        <div class="flex items-center gap-2 rounded-full border border-[#d6e4f2] bg-white px-3 py-2 text-xs font-semibold text-[#2a5a94]">
                            <i class="fa-solid fa-clock text-[#2fbdef]"></i> Ответ за 15 минут
                        </div>
                    </div>
                </div>

                <!-- right: price + quick form -->
                <div class="fade-up" style="transition-delay:.07s">
                    <div id="book" class="rounded-3xl border border-[#d9e7f3] bg-white p-6 shadow-[0_12px_30px_rgba(8,36,70,0.10)]">
                        ...
                        <p class="mt-1 text-sm text-[#355b89]">Оставьте телефон — перезвоним за 15 минут.</p>
                        ...
                        <p class="mt-3 text-[0.7rem] leading-snug text-[#7a9ab8]">Нажимая кнопку, вы соглашаетесь с обработкой персональных данных (ФЗ&nbsp;№&nbsp;152).</p>
